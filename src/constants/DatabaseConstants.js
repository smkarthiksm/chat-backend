...
export const CHAT_CREATION_TABLE = 'Chat';
export const FK_USER_CHAT_CREATION = 'fk_user_chat';
export const CREATED_AT = 'createdAt';

export const CHAT_MEMBERS_MAPPING_TABLE = 'ChatMembersMapping';
export const FK_CHAT_CREATION_CHAT_MEMBERS_MAPPING = 'fk_chat_chatMembersMapping';
